...
# Set environment variables for pyhia8 and lhapdf libraries. You will need to point the path to your local MadGraph folder; for example, PYTHIA8DATA=/path_to_MadGraph/MadGraph_3_5_1/HEPTools/pythia8/share/Pythia8/xmldoc/. The same for LHAPDF_DATA_PATH.
